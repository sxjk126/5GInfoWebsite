...
$yourName = 'Rav Kang';
$yourEmail = 'rkang@highline.edu';
$yourSubject = 'REQUEST FROM CS WEB PAGE';
$referringPage = 'http://www.flightline.highline.edu/cis';
...
return stripslashes($nStr);
	...
	$to = $yourName;
	$subject = 'R.KANG WEB Mail: '.cleanPosUrl($_POST['posRegard']);
	...
	$mailit = mail($to,$subject,$message,$headers);
		...
		{ $posStatus = 'NOTOK'; $posConfirmation = ''; }
